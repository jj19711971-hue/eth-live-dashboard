  ...
  return (
    <div style={{ position: 'relative', width: 92, height: 92 }}>
      <svg width={92} height={92} style={{ transform: 'rotate(-90deg)' }}>
        <circle cx={cx} cy={cy} r={r} fill="none" stroke="#e0e0e0" strokeWidth="7" />
      ...
      <div style={{
        ...
        <span style={{ fontSize: 9, color: '#aaa', letterSpacing: 0.3 }}>Forecast Score</span>
        <span style={{ fontSize: 18, fontWeight: 700, color: '#111', lineHeight: 1.1 }}>
