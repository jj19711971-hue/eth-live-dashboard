...
export function getSignal(score) {
  if (score >= 70) return {
    th:  'Bullish — ตลาดกระทิง ควรพิจารณาซื้อ',
    sub: 'Signal ส่วนใหญ่เป็น Bullish — แนวโน้มขาขึ้นเริ่มก่อตัว โมเมนตัมฝั่งซื้อเริ่มได้เปรียบ และยืนเหนือเส้นค่าเฉลี่ยได้มั่นคง หาก ADX พุ่งทะลุ 25 จะเป็นการยืนยัน ขาขึ้นรอบใหม่ เล่นแบบ Spot มีของอยู่แล้ว แนะนำถือต่อ รอจังหวะขาย แทนที่จะรีบขายหมู ถ้าไม่มีของ ตอนนี้อาจจะแพงไปแล้ว',
    color: '#2d6a4f', bg: '#d8f3dc', border: '#b7e4c7', icon: '▲'
  }
  if (score >= 55) return {
    th:  'Slightly Bullish — แนวโน้มเริ่มฟื้นตัว',
    sub: 'สัญญาณบวกอ่อน — แรงซื้อเริ่มกลับมา แต่เทรนด์ยังขาดความแข็งแกร่ง แนะนำให้ พิจารณาทะยอยสะสม กรณีไม่มีของ ในจุดที่ได้เปรียบ และรอให้ ADX พุ่งทะลุ 25 เพื่อยืนยันการเข้าสู่รอบขาขึ้นที่ชัดเจน',
    color: '#52796f', bg: '#e8f5e9', border: '#c8e6c9', icon: '↗'
  }
  if (score >= 45) return {
    th:  'Neutral — รอสัญญาณที่ชัดเจน',
    sub: 'ตลาดไม่มีทิศทางชัดเจน — รอปัจจัยใหม่ๆ มากระตุ้น เช่นข่าวหรือ การประกาศตัวเลขทางเศรษฐกิจ รอดู Breakout ทิศทางราคาไปแนวทาง ขาขึ้นหรือขาลง',
    color: '#7b6914', bg: '#fff9e6', border: '#ffe08a', icon: '→'
  }
  if (score >= 30) return {
    th:  'Slightly Bearish — แรงซื้อเริ่มอ่อนกำลัง',
    sub: 'สัญญาณลบอ่อน — ยังไม่ชัดเจน รอการยืนยันเพิ่มเติม โมเมนตัมฝั่งลบเริ่มก่อตัว ตลาดยังขาดปัจจัยบวกใหม่ๆ แนะนำให้ ถือเงินสด รอความชัดเจน และหลีกเลี่ยงการไล่ราคาในช่วงที่ตลาดยังไม่เลือกทาง',
    color: '#9c4a1a', bg: '#fff3e0', border: '#ffcc80', icon: '↘'
  }
  return {
    th:  'Bearish — ตลาดหมี ควรระวัง',
    sub: 'Signal ส่วนใหญ่เป็น Bearish — รอดูสถานการณ์ จนกว่าจะเกิดสัญญาณกลับตัวที่ชัดเจน เล่นแบบ Spot แนะนำพิจารณาซื้อ ในจุดที่ได้เปลียบ ราคายังอยู่ภายใต้แรงกดดันของเส้นค่าเฉลี่ย ตลาดยังขาดแรงสนับสนุนจากฝั่งซื้อ',
